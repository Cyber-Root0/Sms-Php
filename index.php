...
<head>
				...
				<title>Envio de SMS - Cyber Intelligence</title><link rel="stylesheet" href="https://bootstrapstudio.io/demo//embed//bootstrap/4/default/bootstrap.min.css">
			...
			<body>
				<section class="contact-clean">
					<form method="post" action="#">
						<h2 class="text-center">Envio de SMS - PHP</h2>
			<div class="form-group">
				<input class="form-control is-invalid" type="number" name="number" placeholder="Numero:">
			</div>
			<div class="form-group">
				<textarea class="form-control" name="message" placeholder="Digite Aqui Seu Texto" rows="14"></textarea>
			</div>
			<div class="form-group">
				<button class="btn btn-primary" type="submit">Enviar SMS</button>
			</div>
		</form>
	</section>
...
echo "<br><center><h2>SMS Enviado Com Sucesso!</h2></center>";
